		...
		return (
			<React.Fragment>
				...
				<Container className="mt-3 mb-3">
					...
					<p className="about--description-text">	Viel Spaß mit der Website wünschen Euch </p>
					<div className="about--description-text about--people-grid">
						<div>👨‍💻 
							<a className="about--people-link" href="https://github.com/redalertexpert">Felix</a>,</div>
							<div>👨‍💻 <a className="about--people-link" href="https://github.com/Koenneker">Ferdinand</a>,</div> 
							<div>👨‍💻 <a className="about--people-link" href="https://github.com/hf2000510">Henri</a>,</div> 
							<div>👨‍💻 <a className="about--people-link" href="https://github.com/L04L3R">Jens</a>,</div> 
							<div>👩‍💻 <a className="about--people-link" href="https://github.com/Juliaetta">Julia</a>,</div> 
							<div>👨‍💻 <a className="about--people-link" href="https://github.com/JulianLueders">Julian</a>,</div> 
